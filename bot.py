...
async def main():
    ...
    try:
        ...
        # Текст сообщения (только то, что нужно в группе)
        message_text = "Bahur Temrina Price доступен, тут: 🖤"
        ...
        print(f"🔗 Кнопка: '⚡️ Прайс!' → https://price2026-production.up.railway.app")
